function Pillar_of_Frost_Loop_KT takes nothing returns nothing
    local unit u = GetEnumUnit()
    if(IsUnitTargetableEnemyHitsAll(u, gg_unit_Uktl_0568)) then
        if udg_o <= (3584 + udg_Temp_Int2) then
...
function Trig_Pillar_of_Frost_Tick_KT_Actions takes nothing returns nothing
    local integer udg_Temp_Int = 51
    ...
    local integer offset = 40
    local integer i = 0
    local integer o = 3584
    local unit u
    local unit caster = gg_unit_Uktl_0568
    ...
    elseif udg_Charge_Loop[udg_Temp_Int] == 20 then
        ...
        call ForGroupBJ(GetUnitsInRangeOfLocAll(330.00, udg_Point_Charge_Begin[udg_Temp_Int]), function Pillar_of_Frost_Loop_KT)
        set udg_o = o
...
//===========================================================================
function InitTrig_Pillar_of_Frost_Tick_KT takes nothing returns nothing
    set gg_trg_Pillar_of_Frost_Tick_KT = CreateTrigger()
    call DisableTrigger(gg_trg_Pillar_of_Frost_Tick_KT)
    call TriggerRegisterTimerEventPeriodic(gg_trg_Pillar_of_Frost_Tick_KT, 0.02)
    call TriggerAddAction(gg_trg_Pillar_of_Frost_Tick_KT, function Trig_Pillar_of_Frost_Tick_KT_Actions)
endfunction
