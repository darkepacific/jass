function Pillar_of_Frost_Loop_H takes nothing returns nothing
    local unit u = GetEnumUnit()
    if(IsUnitTargetableEnemyHitsAll(u, udg_yH_Frost_DK)) then
        if udg_o <= (4160 + udg_Temp_Int2) then
...
function Trig_Pillar_of_Frost_Tick_H_Actions takes nothing returns nothing
    local integer udg_Temp_Int = 50
    ...
    local integer offset = 20
    local integer i = 0
    local integer o = udg_z_DK_FROS_H
    local unit u
    local unit caster = udg_yH_Frost_DK
    ...
    elseif udg_Charge_Loop[udg_Temp_Int] == 20 then
        ...
        call ForGroupBJ(GetUnitsInRangeOfLocAll(330.00, udg_Point_Charge_Begin[udg_Temp_Int]), function Pillar_of_Frost_Loop_H)
        set udg_o = o
...
//===========================================================================
function InitTrig_Pillar_of_Frost_Tick_H takes nothing returns nothing
    set gg_trg_Pillar_of_Frost_Tick_H = CreateTrigger()
    call DisableTrigger(gg_trg_Pillar_of_Frost_Tick_H)
    call TriggerRegisterTimerEventPeriodic(gg_trg_Pillar_of_Frost_Tick_H, 0.02)
    call TriggerAddAction(gg_trg_Pillar_of_Frost_Tick_H, function Trig_Pillar_of_Frost_Tick_H_Actions)
endfunction
