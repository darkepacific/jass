function TalentSurvivalHunter takes nothing returns nothing
	...
	/*  Abilities
		...
		Survival Instincts - increases your dodge chance by 50% for 5 sec

		[Q] Mongoose Bite - deals damage based on your bonus agility (Raptor Strike -AoE) ( Lunge Give a Jump) (Heals) (Could become spirit swoop when D)
		[W] Wildfire Bomb - throws a bomb that deals damage in an area (deals damage over time) (knocks enemies back) (talent can be use to push you back) (gain a second charge)
		[E] Spirit Swoop - sends forth an eagle that damages enemies in a line (talent blinds them)
		[E] Lunge - harpoon jump to a location
		[R] Call Pet -
			Bear (Roar)
			Boar (Primal Rage)
		[D] Unleash the Beast - become ranged and increase attack speed
		[F]
			Tar Trap - create a trap that slows, enemies by greater amounts the longer they stay in it
			Stampede
			Feign Death

		Natural Mending - increase you and your pets regenation
		Aspect of the Turtle - gain a shield that reduces all incoming damage by 30% for 5 sec
		Camouflage - after exiting combat, and not moving you and your pets blend in your surroundings, becoming invisible, until attacking or moving.
